...
import com.mj.BinarySearchTree1.BinarySearchTree.Visitor;
import com.mj.BinarySearchTree1.file.Files;
import com.mj.BinarySearchTree1.printer.BinaryTreeInfo;
import com.mj.BinarySearchTree1.printer.BinaryTrees;
...
public class Main {
	...
	static void test2() {
		...
		BinarySearchTree<Person> bst2 = new BinarySearchTree<>((Person o1, Person o2) -> o2.getAge() - o1.getAge());
		for (int i = 0; i < data.length; i++) {
