...
| 1-3 课程学习的更多注意事项 | [无代码] |
| 1-4 课程编程环境的安装 | [无代码] |
| **第二章 不要小瞧数组** | [章节Java源码](Arrays/) |
| 2-1 使用Java中的数组 | [Java](Arrays/Array-Basics/src/) |
| 2-2 二次封装属于我们自己的数组 | [Java](Arrays/02-Create-Our-Own-Array/src/) |
| 2-3 向数组中添加元素 | [Java](Arrays/03-Add-Element-in-Array/src/) |
| 2-4 数组中查询元素和修改元素 | [Java](Arrays/04-Query-and-Update-Element/src/) |
| 2-5 包含，搜索和删除 | [Java](Arrays/05-Contain-Find-and-Remove/src/) |
| 2-6 使用泛型 | [Java](Arrays/06-Generic-Data-Structures/src/) |
| 2-7 动态数组 | [Java](Arrays/07-Dynamic-Array/src/) |
| 2-8 简单的复杂度分析 | [无代码] |
| 2-9 均摊复杂度和防止复杂度的震荡 | [Java](Arrays/09-Amortized-Time-Complexity/src/) |
